...
public class Player : Actor {
    ...
    public override void Update() {
        base.Update();
        if (lastCheckedHealth != healthSystem.health || lastCheckedShield != healthSystem.shield || lastCheckedLevel != healthSystem.level || lastCheckedHealthStatus != healthSystem.healthStatus || lastCheckedXp != healthSystem.xp)
        {
            ...
            lastCheckedHealthStatus = healthSystem.healthStatus;
